...
import {IdentityCreateSeries, IdentitySeries} from 'type/identity-series';

export interface CreateVideoSeriesProps {
  series?: CreateSeries;
  remove: () => void;
  save: (value: CreateSeries) => void;
}
...
function CreateVideoSeries({series, save, remove}: CreateVideoSeriesProps) {
...
export default CreateVideoSeries;
